...
<video autoPlay muted loop id="myVideo" style={{width:"100vw",height:"100vh",paddingLeft:"1px",paddingRight:"1px"}}>
...
<div id='endbox' style={{marginTop:"5px"}}>
    <div id='endbox4'>
      <iframe id='id4' title="Embedded YouTube Video: Introduction to React Hooks" src={'https://youtube.com/embed/0e9YmChTepo?si=H4__EVxYjIU7LRh9'}    frameborder="0" allowfullscreen></iframe>
    </div>
...
<h1 style={{paddingBottom:"10px",fontSize:"2rem"}}>Our Vision</h1><br></br><p style={{textAlign:"justify",fontSize:"1rem",marginTop:"-40px",paddingBottom:"10px"}}>The vision for Tamil Nadu tourism is to become the most attractive experiential destination in Asia by developing holistic and sustainable tourism experiences that highlight its diverse cultures, ancient traditions, and natural beauty beyond its traditional temples. Key goals include making tourism a major economic sector through industry status for tourism projects, increasing tourist length of stay and spending, and creating inclusive growth with opportunities for local communities.</p> 


  <h2 style={{paddingBottom:"30px",fontSize:"2rem"}}>Address</h2> <p style={{textAlign:"justify",fontSize:"1rem"}}>TamilNadu Tourism Development Corporation Ltd<br></br>
No.2, Tourism Complex, Tourism Complex,<br></br> Mount Road, Anna Salai, Triplicane, Chennai, Tamil Nadu 600002.</p>

 <span style={{color:"violet"}}>Devoleped by IT Support @Vignesh Kumar</span>
</div>
<div id='endbox3'>
<iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d1899754.192055738!2d77.85459592499372!3d11.932588316058393!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3a5268a0c9d6c88f%3A0x44d5dd2991976424!2sTamilNadu%20Tourism%20Development%20Corporation%20Ltd.!5e1!3m2!1sen!2sin!4v1760520911247!5m2!1sen!2sin" title='Map area'  allowfullscreen="" loading="lazy" height="350rem" width="350rem" referrerpolicy="no-referrer-when-downgrade"></iframe>
</div>
</div>
